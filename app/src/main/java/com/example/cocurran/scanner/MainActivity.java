package com.example.cocurran.scanner;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendData() {
        try{
            URL url = new URL("http://conallcurran.com/external/listener.php");
            HttpURLConnection client = (HttpURLConnection) url.openConnection();
            client.setRequestMethod("POST");
            client.setRequestProperty("name","ID");
            client.setDoOutput(true);
            client.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
            int responseCode = client.getResponseCode();
            if (responseCode == HttpURLConnection.HTTP_OK) {
                //System.out.println("Server returned response code " + responseCode + ". Download failed.");
                textView.setText("Server returned response code " + responseCode + ". Client successfully booked in");
                //System.exit(0);
            }
            else{

                textView.setText("Server returned response code " + responseCode + ".  Error in booking");
            }
